...
address_inserts = ["INSERT INTO CUST_ADDR (Cust_addr_id, Cust_addr_street, Cust_addr_city, Cust_addr_state, Cust_addr_aptnum, Cust_addr_zip, Customer_id) VALUES"]
for i in range(1, 101):
    ...
    customer_id = i
    address_inserts.append(f"({addr_id}, '{street}','{city}', '{state}','{apt_num}', {zip_code}, {customer_id}),")
